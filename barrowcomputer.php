...
<div class="row">
  ...
  <h1 class="text-center">Overall Computer To Barrowed</h1>
...
<div class="panel-body">
  ...
  <tr>
    ...
    <td class="text-center">
    <form action="barrowcomputerview.php" method="get" style="display:inline;">
  ...
  <button type="submit" class="btn-custom" data-toggle="tooltip">
    ...
    <td class="text-center">
    <form action="barrowcomputerbarrowedit.php" method="get" style="display:inline;">
    <input type="hidden" name="id" value="<?php echo (int)$product['id']; ?>">

...
?>
<?php $electric_files = find_all('electric');?>
<?php
if (isset($_POST['submit'])) {
  $photo = new electric();
  $photo->upload($_FILES['file_upload']);
  
  if ($photo->process_electric()) {
      $session->msg('s', 'Photo has been uploaded.');
      redirect('bar19.php?success=true'); // Redirect with success parameter
  } else {
...
<center><h1>Add Barcode|ElectricFan</h1></center>
     <div class="row">
        ...
        <div style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="panel panel-default">
          <div  style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="panel-heading clearfix">
            ...
            <div class="pull-right">
              <form class="form-inline" action="bar19.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="panel-body">
            <table class="table">
              <thead>
                ...
                <tbody>
                <?php foreach ($electric_files as $electric_file): ?>
                <tr class="list-inline">
                 <td class="text-center"><?php echo count_id();?></td>
                  <td class="text-center">
                      <img src="uploads/products/<?php echo $electric_file['file_name'];?>" class="img-thumbnail" />
                  </td>
                <td class="text-center">
                  <?php echo $electric_file['file_name'];?>
                </td>
                <td class="text-center">
                  <?php echo $electric_file['file_type'];?>
                </td>
                <td class="text-center">
                  <a href="delete_bar19.php?id=<?php echo (int) $electric_file['id'];?>" class="btn btn-danger btn-xs"  title="Edit">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (successParam === 'true') {
        ...
        swal("", successMessage, "success")
            .then((value) => {
                window.location.href = 'bar19.php'; // Redirect back to media.php after user closes alert
            });
    }
});
</script>

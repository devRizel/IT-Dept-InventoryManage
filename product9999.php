...
function printTable(tableId) {
    ...
    var tableContents = document.getElementById(tableId).outerHTML;

    // Construct the print contents with header and table
    var printContents = '<div class="print-container">' + imgContents + tableContents + '</div>';
    var originalContents = document.body.innerHTML;

    document.body.innerHTML = printContents;

    // Adding CSS for page styling
    var style = '<style>';
    style += '@page { margin: 1cm; size: auto; counter-increment: page }';
    style += '.page-header { position: fixed; top: 0; left: 0; right: 0; height: 1cm; text-align: center; }';
    style += '.page-header::after { content: "Page " counter(page); }';
    style += '.print-container { page-break-after: always; }'; // Ensure table starts on new page
    style += '</style>';

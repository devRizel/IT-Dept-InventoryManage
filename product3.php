...
<div class="row">
  ...
  <div class="search-container" style="display: inline-block; margin-left: 10px;">
    ...
    <td class="text-center">
    <form action="product3main.php" method="get" style="display:inline;">
    ...
    <td class="text-center">
    <form action="product3view.php" method="get" style="display:inline;">
  <input type="hidden" name="id" value="<?php echo (int)$product['id']; ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (successParam === 'true') {
        ...
        swal("", successMessage, "success")
            .then((value) => {
                window.location.href = 'product3.php';
            });
    }
});
</script>

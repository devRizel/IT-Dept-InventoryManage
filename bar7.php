        ...
        <div style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="panel panel-default">
          <div  style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="panel-heading clearfix">
            ...
            <div class="pull-right">
              <form class="form-inline" action="bar7.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="panel-body">
            <table class="table">
              <thead>
                ...
                <td class="text-center">
                  <a href="delete_bar7.php?id=<?php echo (int) $power1_file['id'];?>" class="btn btn-danger btn-xs"  title="Edit">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (successParam === 'true') {
        ...
        swal("", successMessage, "success")
            .then((value) => {
                window.location.href = 'bar7.php'; // Redirect back to media.php after user closes alert
            });
    }
});
</script>

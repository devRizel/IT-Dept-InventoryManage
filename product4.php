...
<div class="row">
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        <h1 class="text-center">IT Comlab 2</h1>
  ...
  <div class="search-container" style="display: inline-block; margin-left: 10px;">
    ...
    <td class="text-center">
    <form action="product4main.php" method="get" style="display:inline;">
    ...
    <td class="text-center">
    <form action="product4view.php" method="get" style="display:inline;">
  <input type="hidden" name="id" value="<?php echo (int)$product['id']; ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (successParam === 'true') {
        ...
        swal("", successMessage, "success")
            .then((value) => {
                window.location.href = 'product4.php';
            });
    }
});
</script>

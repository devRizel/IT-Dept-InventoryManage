  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        <h1 class="text-center">Other Devices Maintenance</h1>
          ...
          <table class="table table-bordered" id="product-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
    <form action="otherdevicesmain.php" method="get" style="display:inline;">
    ...
    <td class="text-center">
    <form action="otherdevicesview.php" method="get" style="display:inline;">
  <input type="hidden" name="id" value="<?php echo (int)$product['id']; ?>">

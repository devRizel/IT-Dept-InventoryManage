  ...
  <div class="col-md-offset-2 col-md-8 ">
    <div style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="col-md-12">
          <form method="post" action="add_product4.php" class="clearfix">
          <div class="form-group col-md-8 col-md-offset-2">
            ...
            <center><div class="form-group ">
              ...
              <a  style=" border-radius: 50% 10% 50% 10% / 10% 50% 10% 50%; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" href="product4.php" class="btn btn-danger" class="">Cancel</a>
            </div></center>
          </form>
        </div>
      </div>

  ...
  <div class="col-md-offset-2 col-md-8">
    <div style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="panel panel-default">
      ...
      <div class="panel-body">
        <form method="post" action="edit_product4.php?id=<?php echo (int)$product['id'] ?>">
          ...
          <center><div class="form-group">
            ...
            <a  style=" border-radius: 50% 10% 50% 10% / 10% 50% 10% 50%; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" href="product4.php" class="btn btn-danger">Cancel</a>
          </div></center>
        </form>
      </div>
    </div>

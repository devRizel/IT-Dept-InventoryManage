...
if (isset($_POST['submit'])) {
  ...
  if ($photo->process_printer()) {
      ...
      redirect('bar17.php?success=true'); // Redirect with success parameter
  } else {
...
<center><h1>Add Barcode|Printer</h1></center>
     <div class="row">
        ...
        <div style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="panel panel-default">
          <div  style="box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);" class="panel-heading clearfix">
            ...
            <div class="pull-right">
              <form class="form-inline" action="bar17.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="panel-body">
            <table class="table">
              <thead>
                ...
                <td class="text-center">
                  <a href="delete_bar17.php?id=<?php echo (int) $printer_file['id'];?>" class="btn btn-danger btn-xs"  title="Edit">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (successParam === 'true') {
        ...
        swal("", successMessage, "success")
            .then((value) => {
                window.location.href = 'bar17.php'; // Redirect back to media.php after user closes alert
            });
    }
});
</script>
